...
void man(char *name)
{
    ...
    else if(strcmp(name, "write")==0)
    {
        ...
        printf("Usage : write File_name\n After this enter this data that we want to write\n");
    }
    ...
    {
        printf("Description : Used to change file offsets\n");
        printf("Usage : lseek File_name ChangeInOffset StartPoint\n");
    }
    else if(strcmp(name,"rm")==0)
    {
        printf("Description : Used to felete the file\n");
...
void DisplayHelp()
{
    printf("ls : To list all the files\n");
    printf("clear : To clear the console\n");
    printf("open : To open the files\n");
    printf("close : To close the files\n");
    printf("closeall : To close all opened files\n");
    printf("read : To to read the content from the file\n");
    printf("write : To to write content into file \n");
...
int ReadFile(int fd, char *arr, int isize)
{
    ...
    if(read_size<isize)
    {
        ...
        UFDTArr->ptrfiletable->readoffset = UFDTArr[fd].ptrfiletable->readoffset + read_size;
    }
    else
    {
        strncpy(arr,(UFDTArr[fd].ptrfiletable->ptrinode->Buffer) + (UFDTArr[fd].ptrfiletable->readoffset),isize);

        UFDTArr->ptrfiletable->readoffset = UFDTArr[fd].ptrfiletable->readoffset + isize;
    }
...
int WriteFile(int fd, char *arr, int isize)
{
    ...
    if(((UFDTArr[fd].ptrfiletable->ptrinode->FileType) != WRITE) && ((UFDTArr[fd].ptrfiletable->ptrinode->Permission) != READ+WRITE))     return -1;
...
int fstat_file(int fd)
{
    ...
    printf("\n ----------Stastistical Information about file--------\n");
    printf("File name : %s\n",temp->FileName);
    ...
    else if(temp->Permission == 2)  printf("File permission : Write Only\n");
    else if(temp->Permission == 3)  printf("File permission : Read & Write Only\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            else if(strcmp(command[0],"cloaseall") == 0)
            {
                CloseAllFile();
        ...
        else if(count == 2)
        {
            if(strcmp(command[0],"stat") == 0)
            {
                ...
                if(ret == -2) printf("ERROR : There is np such file\n");
                continue;
            }
            ...
            else if(strcmp(command[0],"close") == 0)
            {
                ...
                if(ret == -1) printf("ERROR : There is np such file\n");
                continue;
            }
            ...
            else if(strcmp(command[0],"write")==0)
            {
                ...
                if(ret == -3) printf("ERROR : It is not regular file\n");
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0) printf("File successfully created with file descriptor : %d\n",ret);
                if(ret == -1) printf("ERROR : Incorrect parameters\n");
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0) printf("File successfully opened with file descriptor : %d\n",ret);
                if(ret == -1) printf("ERROR : Incorrect parameters\n");
                if(ret == -2) printf("ERROR : There is no inodes\n");
                if(ret == -3) printf("ERROR : File not present\n");
                if(ret == -4) printf("ERROR : Permission Denied \n");
                continue;
            }
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ret == -4) printf("ERROR : It is not existing file\n");
                if(ret > 0) 
                {
                    write(2, ptr, ret);
                }
